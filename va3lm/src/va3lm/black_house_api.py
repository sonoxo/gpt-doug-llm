...
from va3lm.od_plane import ODScenario, od_plane_status, simulate_od_scenario
...
@router.get("/api/black-house/od")
def black_house_od_plane() -> dict:
    return od_plane_status()


@router.post("/api/black-house/od/simulate")
def black_house_od_simulate(scenario: ODScenario) -> dict:
    return simulate_od_scenario(scenario)
...
<div class="card od"><h2>O/D SIMULATION PLANE</h2><small>Sense · Fuse · Assess · Emulate · Defend · Verify</small><pre id="odPlane">Loading…</pre></div>
