...
app = FastAPI(title="VA3LM // BIG VIRGINIA", version="0.3.0")
...
@app.get("/healthz")
def healthz() -> dict:
    return {"status": "ok", "service": "va3lm", "port": 8088, "version": "0.3.0"}
