...
app = FastAPI(title="VA3LM", version="0.1.0")
...
@app.get("/api/status")
def status() -> dict:
    return {"name": "VA3LM", "brain": "gpt-doug-llm", "port": 8088, "agents": len(roster()), "approvalGate": True}
